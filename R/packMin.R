# Unlinked documentation for package packMin 
# main help file + datasets

#' Minimal npde package
#' 
#' Minimal package to explore R tricks, using low-level NpdeData functions from the npde package
#' 
#' \tabular{ll}{ Package: \tab packMin\cr Type: \tab Package\cr Version: \tab
#' 1.0\cr Date: \tab 2017-01-02\cr License: \tab GPL version 2 or later\cr }
#' See the documentation for packMin for details
#' 
#' @name packMin-package
#' @docType package
